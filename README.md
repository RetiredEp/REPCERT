...
Configure environment variables in .env (database and IPFS connection details)
Compile the smart contract: node ethereum/compile.js
Deploy the smart contract: node ethereum/deploy.js
